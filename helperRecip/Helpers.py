...
class Helpers(unittest.TestCase):
    ...
    def __init__(self, test=None):
        ...
        if test and WebDriverTestCase in test.__class__.mro():
    ...
    def log_time(f):
        """decorator that records function time and stores it to the self.test.benchmark dict with key = function name and value = test duration"""
        def benched_function(*args, **kwargs):
            ...
            args[0].test.benchmarks['results'][f.func_name] = t_total
            return output
