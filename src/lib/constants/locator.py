...
class LhnMenu(object):
    ...
    PROGRAMS_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Program"]'
                           '[data-test-id='
                           '"button_lhn_create_new_program_522c563f"]')
...
class ModalCreateNewWorkflow(object):
    ...
    WF_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Workflow"]'
                     '[data-test-id$="522c563f"]')
...
class ModalCreateNewAudit(object):
    AUDIT_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Audit"]'
                        '[data-test-id$="522c563f"]')
...
class ModalCreateNewControlAsses(object):
    CONTROL_ASSES_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular='
                                '"ControlAssessment"]'
                                '[data-test-id$="522c563f"]')
...
class ModalCreateNewIssue(object):
    ISSUE_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Issue"]'
                        '[data-test-id$="522c563f"]')
...
class ModalCreateNewRegulation(object):
    REGULATION_CREATE_NEW = (By.CSS_SELECTOR,
                             '[data-object-singular="Regulation"]'
                             '[data-test-id$="522c563f"]')


class ModalCreateNewPolicy(object):
    POLICY_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Policy"]'
                         '[data-test-id$="522c563f"]')


class ModalCreateNewStandard(object):
    STANDARD_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Standard"]'
                           '[data-test-id$="522c563f"]')


class ModalCreateNewContract(object):
    CONTRACT_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Contract"]'
                           '[data-test-id$="522c563f"]')


class ModalCreateNewClause(object):
    CLAUSE_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Clause"]'
                         '[data-test-id$="522c563f"]')


class ModalCreateNewSection(object):
    SECTION_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Section"]'
                          '[data-test-id$="522c563f"]')
...
class ModalCreateNewControl(object):
    CONTROL_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Control"]'
                          '[data-test-id$="522c563f"]')
...
class ModalCreateNewPerson(object):
    PERSON_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Person"]'
                         '[data-test-id$="522c563f"]')
...
class ModalCreateNewOrgGroup(object):
    ORG_GROUP_CREATE_NEW = (By.CSS_SELECTOR,
                            '[data-object-singular="OrgGroup"]'
                            '[data-test-id$="522c563f"]')


class ModalCreateNewVendor(object):
    VENDOR_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Vendor"]'
                         '[data-test-id$="522c563f"]')
...
class ModalCreateNewSystem(object):
    SYSTEM_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="System"]'
                         '[data-test-id$="522c563f"]')


class ModalCreateNewProcess(object):
    PROCESS_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Process"]'
                          '[data-test-id$="522c563f"]')


class ModalCreateNewDataAsset(object):
    DATA_ASSET_CREATE_NEW = (By.CSS_SELECTOR,
                             '[data-object-singular="DataAsset"]'
                             '[data-test-id$="522c563f"]')


class ModalCreateNewProduct(object):
    PRODUCT_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Product"]'
                          '[data-test-id$="522c563f"]')


class ModalCreateNewProject(object):
    PROJECT_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Project"]'
                          '[data-test-id$="522c563f"]')


class ModalCreateNewFacility(object):
    FACILITY_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Facility"]'
                           '[data-test-id$="522c563f"]')


class ModalCreateNewMarket(object):
    MARKET_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Market"]'
                         '[data-test-id$="522c563f"]')
...
class RiskThreats(object):
    ...
    THREAT_ACTORS = (By.CSS_SELECTOR, '[data-object-singular="ThreatActor"]'
                     '[data-parent=".top-level"]')
    THREAT_ACTORS_COUNT = (By.CSS_SELECTOR,
                           '[data-model-name="ThreatActor"] .item-count')


class ModalCreateNewRisk(object):
    RISK_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular="Risk"]'
                       '[data-test-id$="522c563f"]')
...
class ModalCreateNewThreatActor(object):
    THREAT_ACTOR_CREATE_NEW = (By.CSS_SELECTOR, '[data-object-singular='
                               '"ThreatActor"][data-test-id$="522c563f"]')
...
class AdminDashboardPage(object):
    ...
    class PeopleList(object):
        ...
        ADD_PERSON = (By.CSS_SELECTOR, 'li > a.section-create[data-original-title="Add Person"]')
